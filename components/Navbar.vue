<template>
    <header class="header xl:h-20 sticky top-0 z-50 transition-all ease-in-out bg-purple-100">
      <div class="container xl:w-10/12 2xl:w-9/12 mx-auto xl:px-3">
        <div class="xl:grid xl:grid-cols-7 w-full place-items-center xl:place-items-start">
          <!-- Logo -->
              ...
              <a href="#"
                ...
                <svg class="inline h-10 mb-3 text-violet-900" viewBox="0 0 582 165" fill="none"
                  ...
                  <defs>
                    ...
                    <linearGradient id="paint1_linear" x1="63.5" y1="60.5" x2="-40.5" y2="164.5"
                      gradientUnits="userSpaceOnUse">
          ...
          <!-- Menu -->
          <div class="xl:col-span-3 xl:text-center navbar-link hidden xl:block">
            <ul class="xl:flex xl:gap-5 xl:place-content-center">
              <li class="relative">
                <a href="#" class="block text-sm xl:text-normal p-3.5 xl:px-2 xl:py-7"><span>Blog</span></a>
              </li>
              <li class="relative">
                <a href="#" class="block text-sm xl:text-normal p-3.5 xl:px-2 xl:py-7"><span>Kabar</span></a>
              </li>
              <li class="relative">
                <a href="#" class="block text-sm xl:text-normal p-3.5 xl:px-2 xl:py-7"><button type="button"
                    class="flex items-center gap-x-1 text-sm leading-6 text-gray-900" aria-expanded="false">
                    Layanan
              ...
              <li class="relative">
                <a href="#" class="block text-sm xl:text-normal p-3.5 xl:px-2 xl:py-7"><span>Cek Ongkir</span></a>
              </li>
              <li class="relative">
                <a href="#" class="block text-sm xl:text-normal p-3.5 xl:px-2 xl:py-7"><span>Lacak</span></a>
              </li>
            </ul>
          </div>
  
          <!-- Button Register and Log In -->
          <div class="hidden xl:flex ml-auto xl:col-span-2 navbar-shortcut">
            <ul class="xl:flex xl:gap-7 xl:place-content-end">
              <li>
                <a href="" class="block text-sm xl:text-normal p-3.5 xl:px-0 xl:py-7">
                  <span>Masuk</span></a>
              </li>
              <li class="xl:py-4 pt-2 pb-5 px-3 xl:px-0">
                <a href="" class="block text-white py-3 pl-5 pr-14 rounded-full relative bg-violet-950 hover:bg-violet-600">
                  <span>Daftar Gratis</span>
                  <svg xmlns="http://www.w3.org/2000/svg" class="absolute top-1/2 right-5 -translate-y-1/2" width="24"
