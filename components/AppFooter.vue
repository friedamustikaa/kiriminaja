<template>
  <footer class="py-3 xl:py-14 dark:text-white relative">

    <div class="container xl:w-10/12 2xl:w-9/12 mx-auto px-3 relative">
      <div class="grid xl:grid-cols-2 xl:gap-20 mb-20 text-neutral-950">
        <div class="xl:w-9/12">
          ...
          <p class="mb-10">KiriminAja adalah sebuah platform order pengiriman berbagai ekspedisi, agar para online seller
            dapat dengan mudah melakukan pengiriman paket COD maupun NON COD ke seluruh Indonesia.</p>
          <ul class="xl:w-7/12 mb-5 grid gap-y-3 text-sm text-neutral-600 text-opacity-80">
            <li class="pl-12 relative h-10 place-items-center flex">
              <div
                class="absolute p-1.5 left-0 bg-violet-900 text-violet-950 dark:text-primary-400 top-0.5 bg-opacity-30 rounded-full">
        ...
        <div class="grid gap-5 xl:grid-cols-2 xl:pt-12">
          <div>
            <p class="font-medium mb-3"> Tautan Cepat </p>
            <ul class="grid gap-y-2.5">
              <li>
                <a href="#" class="block">Cek Tarif Aja</a>
              </li>
              <li>
                <a href="#" class="block">Kabar Buatmu</a>
              </li>
              <li>
                <a href="#" class="block">Manajemen Order</a>
              </li>
              <li>
                <NuxtLink to="/integration" class="block">
                  <p> Integrasi API </p>
                </NuxtLink>
              </li>
              <li>
                <a href="#" class="block">Karir</a>
              </li>
          </ul>
        </div>
        <div>
          <p class="font-medium mb-3"> KiriminAja </p>
          <ul class="grid gap-y-2.5">
            <li>
            ...
            <li>
              <a href="#" class="block">Syarat & Ketentuan</a>
            </li>
            <li>
              <a href="#" class="block">Kebijakan Privasi</a>
            </li>
            <li>
              <a href="#" class="block">Fakta & Pertanyaan</a>
            </li>
          </ul>
        </div>
      </div>
